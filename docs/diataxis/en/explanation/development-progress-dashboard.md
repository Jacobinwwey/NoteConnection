...
| Runtime storage/retrieval | Operational baseline | Current Windows-host strict release-evidence history audit now passes at 3/3 for sqlite and ANN; next movement is multi-host evidence plus threshold calibration. |
