...
- Use [Agent Knowledge Workspace Graph Preview and Review Closure (2026-06-20)](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md) for the current matched-file, Focus/Path preview, DAG-context, and final-answer review closure.
...
- 当前 agent knowledge 的命中文件、Focus/Path 图预览、DAG 上下文与最终回答审核收口请查看 [Agent 知识工作区图预览与回答审核收口（2026-06-20）](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md)。
...
- Use [Agent Knowledge Workspace Graph Preview and Review Closure (2026-06-20)](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md) when working on matched-file click affordances, source highlighting, Focus/Path preview projection, DAG-context usage, or final public-answer review.
...
- 处理命中文件可点击提示、source highlight、Focus/Path 图预览投影、DAG context 使用或最终公开回答审核时，请查看 [Agent 知识工作区图预览与回答审核收口（2026-06-20）](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md)。
