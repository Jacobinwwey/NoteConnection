...
- Use [Agent Knowledge Workspace Graph Preview and Review Closure (2026-06-20)](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md) when working on matched-file click affordances, source highlighting, Focus runtime docking, Godot Future Path dispatch, DAG-context usage, or final public-answer review.
...
- 处理命中文件可点击提示、source highlight、Focus runtime 停靠、Godot Future Path 调度、DAG context 使用或最终公开回答审核时，请查看 [Agent 知识工作区图预览与回答审核收口（2026-06-20）](solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md)。
