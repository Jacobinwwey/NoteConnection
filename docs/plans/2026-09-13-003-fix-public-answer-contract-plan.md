...
- [x] R3: Retain bounded, supported complementary definition claims in the public projection. Preserve math, glossary/artifact filters and compact response limits.
...
- [x] R3：公开投影保留有界、受支持的补充定义声明，同时保留公式、变量表/文档噪声过滤及 compact 限制。
