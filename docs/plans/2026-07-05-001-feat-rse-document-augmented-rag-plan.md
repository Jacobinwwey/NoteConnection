...
- Add tests for:
  ...
  - conflicting adjacent, same-section non-adjacent, cross-document structured measurement/date evidence, and remote facts discovered by full-document scan outside the local paragraph window;
