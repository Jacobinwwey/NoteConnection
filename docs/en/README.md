...
[Root README](https://github.com/Jacobinwwey/NoteConnection/blob/main/README.md) | [中文文档](../zh/README.md) | [中文根 README](https://github.com/Jacobinwwey/NoteConnection/blob/main/README_zh.md) | [Quick Start](#quick-start) | [Feature Tour](#feature-tour) | [Architecture](#architecture) | [CLI](#cli-reference) | [Documentation](#documentation) | [Acknowledgments](#acknowledgments)
...
- [Agent Knowledge Workspace Graph Preview and Review Closure](../solutions/agent-knowledge-workspace-graph-preview-and-review-closure-2026-06-20.md)
- [Knowledge Workspace and DAG Alignment Plan](../solutions/knowledge-workspace-dag-alignment-2026-06-10.md)
...
Use `npm run mobile:build:release` for the primary Android release path. It targets Tauri Android and runs the slim budget and Android prerequisite gates. `npm run mobile:build:compatibility` remains an explicit compatibility check for the historical Capacitor plus Tauri pair, not a release path.
...
- [English app_config guide](app_config.toml_guide.md)
- [Config template](../examples/app_config.template.toml)
...
- Root English README: [README.md](https://github.com/Jacobinwwey/NoteConnection/blob/main/README.md)
- Root Chinese README: [README_zh.md](https://github.com/Jacobinwwey/NoteConnection/blob/main/README_zh.md)
- Chinese docs mirror: [../zh/README.md](../zh/README.md)
- User manual: [User_Manual.md](User_Manual.md) / [../zh/User_Manual.md](../zh/User_Manual.md)
- Interface document: [Interface Document.md](<Interface Document.md>) / [../zh/Interface Document.md](<../zh/Interface Document.md>)
- Release notes: [../release_notes_v1.8.0.md](../release_notes_v1.8.0.md)
...
This project is licensed under the [GNU General Public License v3.0](https://github.com/Jacobinwwey/NoteConnection/blob/main/LICENSE) (`GPL-3.0-only`).
