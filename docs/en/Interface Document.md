...
- Remaining architecture gap:
  - broaden contradiction coverage from the current lexical + query-intent + structured + state + polarity + graph-order stack into richer claim-vs-citation / claim-vs-evidence contradiction classes,
